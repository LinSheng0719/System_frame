...
TableTools.prototype = {
	...
	"_fnButtonBase": function ( o, bCollectionButton )
	{
		...
		/* 添加判断是否配置了 sButtonIClass */
		var buttonHtml = [];
		if(o.sButtonIClass && o.sButtonIClass.length>0){
			buttonHtml.push('<i class="'+o.sButtonIClass+'" >');
			buttonHtml.push('</i> ');
		}
		buttonHtml.push(o.sButtonText);
		nSpan.innerHTML = buttonHtml.join('');
